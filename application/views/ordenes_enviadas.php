...
<div  class="col-lg-12 grid-margin stretch-card"  ng-controller="OrdenesEnviadasCtrl">
            <div class="card ">
                <div class="card-body">
                  <h2 class="p-3 text-center display-5 text-secondary text-uppercase ">Ordenes Enviados</h2><button class="btn btn-primary btn-sm" ng-click="CargarOrdenesEnviadas()"><i class="icon-refresh"></i> Refrescar</button>
                  <!-- <hr> -->
                  <div class="">
                  <!-- <div class="card m-1">
                    <div class="card-body ">
