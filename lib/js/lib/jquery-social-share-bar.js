...
(function ($, window, undefined) {
  ...
  $.fn.share = function (method) {
    ...
    var helpers = {
      channels: {
        facebook: {url: 'https://www.facebook.com/Ublof'},
        twitter: {url: 'https://twitter.com/share?url=|u|&text=|140|'},
        instagram: {url: 'https://www.instagram.com/ublof_com/'},
        ...
        whatsapp: {url: 'https://whatsapp.com/share.php?url=|u|&media=&description=|d|'},
        pinterest: {url: 'https://pinterest.com/pin/create/button/?url=|u|&media=&description=|d|'},
        stumbleupon: {url: 'https://www.stumbleupon.com/submit?url=|u|&title=|t|'},
        youtube: {url: 'http://www.youtube.com/c/UblofOficial'},
        telegram: {url: 'https://t.me/ublof'},
        linkedin: {url: 'https://www.linkedin.com/in/ublof'},
  ...
  $.fn.share.defaults = {
    popupWidth: 640,
    popupHeight: 528,
    channels: ['facebook', 'instagram', 'youtube', 'telegram', 'linkedin'],
    ...
    itemTemplate: function (props) {
      ...
      return '<li class="' + props.provider + '">' +
        '<a href="#" data-href="' + props.href + '" title="Síguenos en ' + (props.provider === 'email' ? 'via ' : 'en ') + providerName + '" class=' + props.itemTriggerClass + ' ' + props.provider + '">' +
